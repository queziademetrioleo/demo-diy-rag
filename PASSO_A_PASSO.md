...
### Streamlit não atualiza código modificado

**Causa:** Cache do Streamlit mantém código antigo

**Soluções:**

**Opção 1 (Recomendada):**
1. Na sidebar do app, clicar "🔄 Recarregar Sistema"
2. Aguardar reload

**Opção 2:**
```bash
# Editar simple_app.py
nano simple_app.py

# Mudar linha 38:
CODE_VERSION = "2.0.1-llm"  # Incrementar versão
...
Para desenvolvimento/testes: **praticamente gratuito** (free tier cobre!)
