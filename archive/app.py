"""
🤖 Interactive Chat App - Product RAG System
Web app to test the RAG system interactively.
ChatGPT-like interface for product questions.
"""
...
def load_faq_system(_version):
    ...
    Uses cache to avoid reloading every time.
